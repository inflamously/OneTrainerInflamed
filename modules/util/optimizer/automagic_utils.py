...
#
# Source: https://github.com/ostris/ai-toolkit/blob/2b4c525489c6fd42a8e99724d9c528b3dcbecb92/toolkit/optimizers/optimizer_utils.py
# (original lines ~168+; link pinned to commit for stability)
# Imported into an AGPL-3.0 project on 2025-08-11.
# Modifications: File renamed, small edits to make it work within OneTrainer, removed unused code
