...
from modules.util.optimizer.automagic_utils import Auto8bitTensor, stochastic_grad_accummulation, copy_stochastic
...
# (original lines ~168+; link pinned to commit for stability)
# Imported into an AGPL-3.0 project on 2025-08-11.
# Modifications: Small edits to make it work within OneTrainer + different default params
...
class Automagic(torch.optim.Optimizer):
    def __init__(
        ...
        print("Automagic loaded with defaults of", defaults)
